...
var _velement = __webpack_require__(/*! ./vdom/velement.js */ "./client/secret-login/vdom/velement.js");

var _velement2 = _interopRequireDefault(_velement);

var _diff = __webpack_require__(/*! ./vdom/diff.js */ "./client/secret-login/vdom/diff.js");

var _diff2 = _interopRequireDefault(_diff);

var _patch = __webpack_require__(/*! ./vdom/patch.js */ "./client/secret-login/vdom/patch.js");
...
var vdom = (0, _velement2.default)('form', { class: 'form form--spwd' }, [(0, _velement2.default)('div', { class: 'field' }, [(0, _velement2.default)('span', { class: 'title' }, ['二级密码:']), (0, _velement2.default)('input', { class: 'input', type: 'password' })]), (0, _velement2.default)('div', { class: 'field' }, [(0, _velement2.default)('input', { class: 'btn-submit', type: 'button', value: '修改' })])]);
var rootnode = vdom.render();
(0, _$2.default)('#root').appendChild(rootnode);

var newVdom = (0, _velement2.default)('form', { class: 'form form--spwd' }, [(0, _velement2.default)('div', { class: 'field' }, [(0, _velement2.default)('span', { class: 'title' }, ['二级密码:']), (0, _velement2.default)('input', { class: 'input', type: 'password' })]), (0, _velement2.default)('div', { class: 'field' }, [(0, _velement2.default)('input', { class: 'btn-submit', type: 'button', value: '提交' })])]);

(0, _patch2.default)(rootnode, (0, _diff2.default)(vdom, newVdom));
...
/***/ "./client/secret-login/vdom/diff.js":
/*!******************************************!*\
  !*** ./client/secret-login/vdom/diff.js ***!
  \******************************************/
/*! no static exports found */
...
var _patch = __webpack_require__(/*! ./patch.js */ "./client/secret-login/vdom/patch.js");

var _patch2 = _interopRequireDefault(_patch);

var _listDiff = __webpack_require__(/*! ./list-diff.js */ "./client/secret-login/vdom/list-diff.js");
...
/***/ "./client/secret-login/vdom/list-diff.js":
/*!***********************************************!*\
  !*** ./client/secret-login/vdom/list-diff.js ***!
  \***********************************************/
/*! no static exports found */
...
exports.default = function (oldList, newList, key) {

  var oldMap = _makeKeyIndexAndFree(oldList, key);
  var newMap = _makeKeyIndexAndFree(newList, key);
  ...
  while (i < newList.length) {
    ...
    var simulateItemKey = _getItemKey(simulateItem, key);
    ...
    if (simulateItem) {
      ...
      if (itemKey === simulateItemKey) {
        ...
        if (!oldKeyIndex.hasOwnProperty(itemKey)) {
          ...
          // then just remove it
          var nextItemKey = _getItemKey(simulateList[j + 1], key);
...
function _makeKeyIndexAndFree(list, key) {
  ...
  for (var i = 0, len = list.length; i < len; ++i) {
    ...
    var item = list[i];
    var itemKey = _getItemKey(item, key);
 ...
 */
var _remove = function _remove(moves, index) {
  return moves.push({ index: index, type: 0 });
};
 ...
 * @param {Object} item - 虚拟DOM对象
 */
var _insert = function _insert(moves, index, item) {
  return moves.push({ index: index, item: item, type: 1 });
};
 ...
 * @param {Number} index - 索引
 */
var _removeSimulate = function _removeSimulate(simulateList, index) {
  return simulateList.splice(index, 1);
};
...
/***/ "./client/secret-login/vdom/patch.js":
/*!*******************************************!*\
  !*** ./client/secret-login/vdom/patch.js ***!
  \*******************************************/
/*! no static exports found */
...
var _util = __webpack_require__(/*! ./util.js */ "./client/secret-login/vdom/util.js");
...
function reoderChildren(node, moves) {
  ...
  var staticNodeList = [].concat((0, _toConsumableArray3.default)(node.childNodes));
  ...
  moves.forEach(function (move) {
    ...
    } else if ((0, _typeof3.default)(move.item) === 'object') {
...
function setProps(node, props) {
  ...
  for (var key in props) {
    ...
    if (props[key] === void 0) {
      ...
      (0, _util.setAttr)(node, key, props[key]);
    }
  }
}
...
/***/ "./client/secret-login/vdom/util.js":
/*!******************************************!*\
  !*** ./client/secret-login/vdom/util.js ***!
  \******************************************/
/*! no static exports found */
...
/***/ "./client/secret-login/vdom/velement.js":
/*!**********************************************!*\
  !*** ./client/secret-login/vdom/velement.js ***!
  \**********************************************/
/*! no static exports found */
 ...
 */
var VElement = function VElement(tagName) {
...
VElement.prototype.render = function () {
  ...
  for (var propName in props) {
    (0, _util.setAttr)(el, propName, props[propName]);
  }
