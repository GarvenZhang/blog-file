...
function validateInteger (value, name) {
  ...
  if (typeof value !== 'number') { err = new ERR_INVALID_ARG_TYPE(name, 'number', value) } else if (!Number.isSafeInteger(value)) { err = new ERR_OUT_OF_RANGE(name, 'an integer', value) }
