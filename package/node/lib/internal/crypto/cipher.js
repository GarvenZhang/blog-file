...
function getUIntOption (options, key) {
  ...
  if (options && (value = options[key]) != null) {
    if (value >>> 0 !== value) { throw new ERR_INVALID_OPT_VALUE(key, value) }
    return value
  }
  return -1
}
...
function createCipher (cipher, password, options, decipher) {
  if (typeof cipher !== 'string') { throw new ERR_INVALID_ARG_TYPE('cipher', 'string', cipher) }
...
Cipher.prototype.setAutoPadding = function setAutoPadding (ap) {
  if (this._handle.setAutoPadding(ap) === false) { throw new ERR_CRYPTO_INVALID_STATE('setAutoPadding') }
  return this
}
...
Cipher.prototype.setAuthTag = function setAuthTag (tagbuf) {
  ...
  // errored
  if (this._handle.setAuthTag(tagbuf) === false) { throw new ERR_CRYPTO_INVALID_STATE('setAuthTag') }
  return this
}
...
Cipher.prototype.setAAD = function setAAD (aadbuf, options) {
  ...
  if (this._handle.setAAD(aadbuf, plaintextLength) === false) { throw new ERR_CRYPTO_INVALID_STATE('setAAD') }
  return this
}
