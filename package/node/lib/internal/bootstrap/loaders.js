...
(function bootstrapInternalLoaders (process, getBinding, getLinkedBinding,
  ...
  if (debugBreak) { debugger } // eslint-disable-line no-debugger
        ...
        const update = (property, value) => {
          if (this.reflect !== undefined &&
              ReflectApply(ObjectHasOwnProperty,
                           this.reflect.exports, [property])) { this.reflect.exports[property].set(value) }
        }
          ...
          defineProperty: (target, prop, descriptor) => {
            ...
            if (typeof descriptor.get === 'function' &&
              ...
              handler.get = (target, prop, receiver) => {
                ...
                if (ReflectApply(ObjectHasOwnProperty, target, [prop])) { update(prop, value) }
                return value
              }
            }
