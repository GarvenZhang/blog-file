...
if (!Connection || !require('internal/worker').isMainThread) { throw new ERR_INSPECTOR_NOT_AVAILABLE() }
...
class Session extends EventEmitter {
  ...
  connect () {
    if (this[connectionSymbol]) { throw new ERR_INSPECTOR_ALREADY_CONNECTED('The inspector session') }
    const connection =
